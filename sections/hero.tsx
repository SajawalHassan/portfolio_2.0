...
export const Hero = () => {
  return (
    <main className="relative ml-[10px] sm:ml-[60px] md:ml-[100px] md:h-[20rem]" id="hero">
      <div className="flex flex-col justify-between w-max absolute inset-y-0 top-[3rem] h-[25rem] sm:h-[40rem] my-auto md:flex-row md:h-max md:w-screen md:max-w-[1100px] xl:max-w-[1600px] md:-left-[12.5rem]">
